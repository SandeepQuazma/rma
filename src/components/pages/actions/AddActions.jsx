  ...
  return (
    <section className="edit-role-access add-role-access">
        <Container>
          <Row>
            <Col className="">
              <h1 className="page-title m-0">Add Action</h1>
            </Col>
                  ...
                  <Form className="row has-label-on-border">
                    <Form.Group className="col-4 mb-3 form-group" controlId="exampleForm.ControlInput1">
                      ...
                      <Form.Select aria-label="Default select example" title="--">
                        <option value="Qoute Admin">Masters</option>
                        <option value="Manager">Brokers</option>
                        <option value="OPS Manager">Quote Management</option>
                      </Form.Select>
                    </Form.Group>
                    ...
                    <Form.Group className="col-4 mb-3 form-group" controlId="exampleForm.ControlTextarea1">
                      <Form.Label>Action Short Name</Form.Label>
                      <Form.Control type="text" placeholder="" />
                    </Form.Group>
                    <Form.Group className="col-12 mb-3 form-group" controlId="exampleForm.ControlTextarea1">
