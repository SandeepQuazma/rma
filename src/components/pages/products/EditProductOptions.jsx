  ...
  return (
    <section className="edit-role-access add-role-access">
      <Container>
        <Row>
          <Col className="">
            <h1 className="page-title m-0">Edit Product Options</h1>
          </Col>
            ...
            <div className="card-body">
              <Form className="row has-label-on-border">
                ...
                <div className="col-12 d-flex flex-row-reverse">
                  <button type="submit" onClick={(e) => { e.preventDefault(); handleAddFields() }} className="btn btn-primary-outline mr-1">Add Options</button>
                </div>
