  ...
  return(
    <div className="tab-pane fade show active">
        <table className="table table-bordered">
            ...
            <tbody>
                <tr>
                    <th><i className="rma rma-user"></i> <span className="member-count">1</span> Members</th>
                ...
                <tr>
                    ...
                    <td>R <span>69.00</span></td>
                    <td>R <span>138.00</span></td>
                    <td>R <span>208.00</span></td>
                    <td>R <span>277.00</span></td>
                    <td>R <span>305.00</span></td>
                    <td>R <span>416.00</span></td>
                </tr>
                <tr>
