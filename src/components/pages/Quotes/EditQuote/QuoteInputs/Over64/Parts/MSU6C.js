  ...
  return(
    <div className="tab-pane fade show active">
        <table className="table table-bordered">
            ...
            <tbody>
                <tr>
                    <th><i className="rma rma-user"></i> <span className="member-count">46</span> Members</th>
                    ...
                    <td><input type="text" value="6" className="form-control member15000" onChange={handleChange} /></td>
                    <td><input type="text" value="30" className="form-control member20000" onChange={handleChange} /></td>
                    <td><input type="text" value="0" className="form-control member22000" onChange={handleChange} /></td>
                    <td><input type="text" value="10" className="form-control member22000" onChange={handleChange} /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>R <span>0.00</span></td>
                    <td>R <span>570.00</span></td>
                    <td>R <span>3750.00</span></td>
                    <td>R <span>0.00</span></td>
                    <td>R <span>1880.00</span></td>
                </tr>
            </tbody>
        </table>
    </div>
