...
export default function QuoteInputs({nextStep ,ageband,premiumOption}){
      ...
      <>
        ...
        <div className="card gray-card">
          <div className="card-body">
            <div className="tab-content">
              ...
              {activeTab === tabInfo.band.label ? <Under64  tabInfo={tabInfo} settabInfo={settabInfo}  productDetails={productDetails} premiumOption={premiumOption}/> : '' }
            </div>
          </div>
        </div>
        <div className="d-flex justify-content-between align-items-center">
          ...
          <div className="preview-btn-wrapper text-right ml-2">
            <button className="btn btn-primary w-100 btn-lg show-preview" onClick={nextStep}>Preview Quote</button>
          </div>
        </div>
      </>
  );
